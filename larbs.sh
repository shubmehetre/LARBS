#!/bin/sh
# Linux Auto Rice Boostrapping Script (LARBS)
# Orignal Author: Luke Smith <luke@lukesmith.xyz>
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/shubmehetre/dotfiles"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/shubmehetre/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Linux Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop\\n\\n-Luke" 10 60
...
pkill -15 -x 'pulseaudio'; sudo -u "$name" pulseaudio --start; amixer sset Master unmute 2>/dev/null
